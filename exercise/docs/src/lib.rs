...
//! in the genus Cucurbita that has culinary and cultural significance but no
//! agreed upon botanical or scientific meaning. The term pumpkin is sometimes used
//! interchangeably with "squash" or "winter squash", and is commonly used for cultivars
//! of Cucurbita argyrosperma, Cucurbita ficifolia, Cucurbita maxima, Cucurbita moschata,
//! and Cucurbita pepo
...
/// # Recipes
///
/// *The recipees will be coming soon*
pub struct Pumpkin {
    /// The percentage of roundness
    pub roundness: f32,
    /// A value from 8 to 17
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// If you _smash_ the pumpkin, it will be gone. 😢
    pub fn smash(self) {}
}
...
/// This constant is used for the `orangeness` field in the [Pumpkin] struct
